import { add as getAdjustedCoordinates, subtract as getCoordinatesDelta, getOwnerDocument, getWindow, isKeyboardEvent, } from '@dnd-kit-svelte/utilities';
            ...
            if (newCoordinates) {
                ...
                for (const scrollContainer of scrollableAncestors) {
                    ...
                    const clampedCoordinates = {
                        x: Math.min(direction === KeyboardCode.Right
                            ? scrollElementRect.right - scrollElementRect.width / 2
                            : scrollElementRect.right, Math.max(direction === KeyboardCode.Right
                            ? scrollElementRect.left
                            : scrollElementRect.left + scrollElementRect.width / 2, newCoordinates.x)),
                    ...
                    if (canScrollX && clampedCoordinates.x !== newCoordinates.x) {
                        ...
                        const canScrollToNewCoordinates = (direction === KeyboardCode.Right && newScrollCoordinates <= maxScroll.x) ||
                ...
                this.handleMove(event, getAdjustedCoordinates(getCoordinatesDelta(newCoordinates, this.referenceCoordinates), scrollDelta));
            }
        }
    }
