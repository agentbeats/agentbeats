...
declare module '$env/static/private' {
	...
	export const GOOGLE_API_KEY_2004Tesseract: string;
	export const GOOGLE_API_KEY_Markus: string;
	export const GOOGLE_API_KEY_Tabi: string;
	export const GOOGLE_API_KEY_Teeseract: string;
	...
	export const TEST_PYPI_TOKEN: string;
	export const TMP: string;
	export const TWINE_USERNAME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GOOGLE_API_KEY_2004Tesseract: string;
		GOOGLE_API_KEY_Markus: string;
		GOOGLE_API_KEY_Tabi: string;
		GOOGLE_API_KEY_Teeseract: string;
		GOPATH: string;
		HOME: string;
		HOMEDRIVE: string;
		HOMEPATH: string;
		...
		TEST_PYPI_TOKEN: string;
		TMP: string;
		TWINE_USERNAME: string;
		USERDOMAIN: string;
