...
echo "Starting Docker service manager (battle_royale)..."
...
echo "Starting battle_royale red agents in background..."
...
echo "Starting tensortrust_mock blue and red agents in background..."
...
echo "- Docker service manager (battle_royale): scenarios/battle_royale/docker (docker-compose)"
...
echo "\n🟢 Please start the following manually/in tmux as needed:"
