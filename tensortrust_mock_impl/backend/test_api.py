...
async def test_api():
    ...
    async with httpx.AsyncClient() as client:
        ...
        green_agent_id = await register_agent(client, "Green Team Agent", "http://localhost:9999")
        blue_agent_id = await register_agent(client, "Blue Team Agent", "http://localhost:9997")
        red_agent_id = await register_agent(client, "Red Team Agent", "http://localhost:9998")
