...
CMD1="cd ../.. && source venv/bin/activate && python -m src.agentbeats_backend.run; exec $SHELL"
# Pane 2: Start MCP server
CMD2="cd ../.. && source venv/bin/activate && python src/agentbeats_backend/mcp/mcp_server.py; exec $SHELL"
# Pane 3: Frontend (npm install and run dev)
CMD3="cd ../.. && cd frontend/webapp && npm install && npm run dev; exec $SHELL"
