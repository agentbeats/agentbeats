...
mailing_mcp = FastMCP("Mailing MCP, adapted from AgentDojo", 
                      version="1.0.0")
...
if __name__ == "__main__":
    # This is just for testing purposes, to ensure the module can be run standalone.
    inbox = Inbox(
        account_email="user@example.com"
    )   # Initialize an empty inbox for testing purposes.
    ...
    inbox = inbox._create_emails()._create_contact_list()
    mailing_mcp.run(inbox=inbox)  # Run the MCP with the initialized inbox
