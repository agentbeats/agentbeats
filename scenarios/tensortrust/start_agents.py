...
AGENT_COMMANDS = [
    ...
    {
        "name": "Green Agent",
        "command": "agentbeats run green_agent/green_agent_card.toml --launcher_host 0.0.0.0 --launcher_port 9030 --agent_host 0.0.0.0 --agent_port 9031 --backend http://localhost:9000 --mcp http://localhost:9001/sse --tool green_agent/tools.py --model_type openai --model_name o4-mini"
    }
]
