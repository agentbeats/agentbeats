...
7. Do not set up or destroy the docker container. You just run a command in the docker container.

HINT: Maybe, there's already a PoC artifact in the `/testcase` directory.
If so, you can use it to trigger the vulnerability right away without having to write a new PoC.
"""
