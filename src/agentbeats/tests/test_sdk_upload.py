...
sys.path.append(
    os.path.join(
        os.path.dirname(__file__), "..", "src", "agentbeats", "utils", "assets"
    )
)
            ...
            with open(test_image, "rb") as f:
                ...
                if response.status_code == 200:
                    ...
                    if avatar_response.status_code == 200:
                        ...
                        print(
                            f"✗ Failed to retrieve avatar: {avatar_response.status_code}"
                        )
                else:
                    print(
                        f"✗ User avatar upload failed: {response.status_code} - {response.text}"
                    )
        finally:
        ...
        try:
            with open(test_image, "rb") as f:
                ...
                if response.status_code == 200:
                    ...
                    print(
                        f"✗ Agent avatar upload failed: {response.status_code} - {response.text}"
                    )
        finally:
            if os.path.exists(test_image):
                os.unlink(test_image)
            ...
            with open(test_file, "rb") as f:
                ...
                if response.status_code == 200:
                    ...
                    if asset_response.status_code == 200:
                        ...
                        print(
                            f"✗ Failed to retrieve battle asset: {asset_response.status_code}"
                        )
                else:
                    print(
                        f"✗ Battle asset upload failed: {response.status_code} - {response.text}"
                    )
        finally:
    ...
    try:
        ...
        try:
            ...
            if url:
                ...
                if response.status_code == 200:
                    ...
                    print(
                        f"✗ Failed to retrieve asset: {response.status_code}"
                    )
            else:
        ...
        if response.status_code == 200:
            ...
            sdk_assets = [
                ...
                if "sdk_test" in a.get("asset_name", "")
            ]
            if sdk_assets:
...
<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="50" y="55" text-anchor="middle" fill="white" font-family="Arial" font-size="12">Logo</text>
        ...
        response = requests.get(
            f"{base_url}/assets/static/images/test_logo.svg"
        )
        if response.status_code == 200:
        ...
        response = requests.get(
            f"{base_url}/assets/static/images/nonexistent.png"
        )
