...
import type { defaultFor, distill, inferIntersection, inferPipe, InferredMorph, Out, To } from "arktype/internal/attributes.ts";
import type { ArkAmbient } from "arktype/config";
import type { type } from "arktype/internal/keywords/keywords.ts";
import type { NaryPipeParser } from "arktype/internal/nary.ts";
