...
import type { distill, Out } from "arktype/internal/attributes.ts";
import type { type } from "arktype/internal/keywords/keywords.ts";
import type { Inferred } from "arktype/internal/methods/base.ts";
import type { BaseCompletions } from "arktype/internal/parser/string.ts";
import type { InternalScope } from "arktype/internal/scope.ts";
