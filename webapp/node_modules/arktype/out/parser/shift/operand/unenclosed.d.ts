...
import type { resolutionToAst } from "arktype/internal/scope.ts";
import type { GenericInstantiationAst } from "arktype/internal/parser/ast/generic.ts";
...
import type { DynamicState } from "arktype/internal/parser/reduce/dynamic.ts";
import type { StaticState, state } from "arktype/internal/parser/reduce/static.ts";
import type { BaseCompletions } from "arktype/internal/parser/string.ts";
import type { ArkTypeScanner } from "arktype/internal/parser/shift/scanner.ts";
import { parseGenericArgs, writeInvalidGenericArgCountMessage, type ParsedArgs } from "arktype/internal/parser/shift/operand/genericArgs.ts";
