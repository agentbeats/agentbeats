...
import type { DateLiteral } from "arktype/internal/attributes.ts";
import type { InferredAst } from "arktype/internal/parser/ast/infer.ts";
import type { astToString } from "arktype/internal/parser/ast/utils.ts";
import type { DynamicState, DynamicStateWithRoot } from "arktype/internal/parser/reduce/dynamic.ts";
import { writeUnpairableComparatorMessage, type Comparator, type InvertedComparators, type MaxComparator } from "arktype/internal/parser/reduce/shared.ts";
