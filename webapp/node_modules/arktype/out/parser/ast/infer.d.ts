...
import type { distill, inferIntersection, inferPipe, LimitLiteral, withDefault } from "arktype/internal/attributes.ts";
...
import type { Comparator } from "arktype/internal/parser/reduce/shared.ts";
import type { ArkTypeScanner } from "arktype/internal/parser/shift/scanner.ts";
import type { GenericInstantiationAst, inferGenericInstantiation } from "arktype/internal/parser/ast/generic.ts";
