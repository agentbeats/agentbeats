...
import type { type } from "arktype/internal/keywords/keywords.ts";
import type { InnerParseResult } from "arktype/internal/scope.ts";
import type { shallowDefaultableMessage, shallowOptionalMessage, validateString } from "arktype/internal/parser/ast/validate.ts";
import { type inferObjectLiteral, type validateObjectLiteral } from "arktype/internal/parser/objectLiteral.ts";
import type { isDefaultable, OptionalPropertyDefinition } from "arktype/internal/parser/property.ts";
import { type BaseCompletions, type inferString } from "arktype/internal/parser/string.ts";
import { type inferTupleExpression, type maybeValidateTupleExpression, type TupleExpression } from "arktype/internal/parser/tupleExpressions.ts";
import { type inferTupleLiteral, type validateTupleLiteral } from "arktype/internal/parser/tupleLiteral.ts";
