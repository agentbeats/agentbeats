...
import type { inferDefinition, validateInnerDefinition } from "arktype/internal/parser/definition.ts";
import { type DefaultablePropertyTuple, type isDefaultable, type OptionalPropertyDefinition } from "arktype/internal/parser/property.ts";
