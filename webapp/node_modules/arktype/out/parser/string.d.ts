...
import type { InnerParseResult, resolutionToAst } from "arktype/internal/scope.ts";
import type { inferAstRoot } from "arktype/internal/parser/ast/infer.ts";
import { DynamicState, type DynamicStateWithRoot } from "arktype/internal/parser/reduce/dynamic.ts";
import type { StringifiablePrefixOperator } from "arktype/internal/parser/reduce/shared.ts";
import type { state, StaticState } from "arktype/internal/parser/reduce/static.ts";
import type { parseOperand } from "arktype/internal/parser/shift/operand/operand.ts";
import { parseDefault } from "arktype/internal/parser/shift/operator/default.ts";
import { writeUnexpectedCharacterMessage, type parseOperator } from "arktype/internal/parser/shift/operator/operator.ts";
