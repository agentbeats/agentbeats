import { getClientRect, isDocumentScrollingElement, Rect } from '../../utilities/index.js';
...
export function useRects(args) {
    ...
    function measureRects() {
        ...
        rects = elements.map((element) => isDocumentScrollingElement(element) ? windowRect.current : new Rect(measure(element), element));
    }
