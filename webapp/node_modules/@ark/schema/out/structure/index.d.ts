...
import { type BaseNode, type DeepNodeTransformContext, type DeepNodeTransformation } from "../node.js";
...
export declare class IndexNode extends BaseConstraint<Index.Declaration> {
    ...
    expression: string;
    flatRefs: import("../node.js").FlatRef<BaseRoot<import("../roots/root.js").InternalRootDeclaration>>[];
