...
SERVICES = {
    ...
    "blue_agent": {
        "command": ["python", "example_agents/agent_launcher.py", "--file", "example_agents/blue_agent/main.py", "--port", "9010"],
        "cwd": ".",
        "env": {},
    ...
    "red_agent": {
        "command": ["python", "example_agents/agent_launcher.py", "--file", "example_agents/red_agent/main.py", "--port", "9020"],
        "cwd": ".",
        "env": {},
    ...
    "green_agent": {
        "command": ["python", "example_agents/agent_launcher.py", "--file", "example_agents/green_agent/main.py", "--port", "9030", "--mcp-url", "http://localhost:9001/sse"],
        "cwd": ".",
...
class ServiceManager:
            ...
            try:
                ...
                if cmd == "kill":
                    ...
                    try:
                        ...
                        subprocess.run(["pkill", "-f", "python.*example_agents/agent_launcher.py"], check=False)
    ...
    def start_all(self):
        ...
        try:
            ...
            subprocess.run(["pkill", "-f", "python.*blue_agent/main.py"], check=False)
            subprocess.run(["pkill", "-f", "python.*red_agent/main.py"], check=False)
            subprocess.run(["pkill", "-f", "python.*green_agent/main.py"], check=False)
